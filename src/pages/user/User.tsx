        ...
        {userLoaded &&
            <div className={'user-post-container'}>
                <div className={'post-wrapper'}>
                    <PostList setSlideMessage={setSlideMessage} editPost={false} page={page} category={''} lastDay={365} setCategory={setCategory} setSelectedCategory={setSelectedCategory} user={user}/>
                </div>
            </div>
        }
